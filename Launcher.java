...
public class Launcher {
    ...
    public static void init(){
        ...
        Desarrollador desarrollador=new Desarrollador("Joselito",7000,"Dsarrollador",lenguajes);
        ...
        GerenteProyecto gerenteProyecto=new GerenteProyecto("Juanito",6000,"GerenteProyecto",empresa.getProyectos());
